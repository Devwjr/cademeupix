...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CadêMeuPix'); ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('dividas.*') ? 'active' : ''); ?>" href="<?php echo e(route('dividas.index')); ?>">
...
<?php /**PATH /home/wesley/cadeMeuPix/resources/views/layouts/app.blade.php ENDPATH**/ ?>