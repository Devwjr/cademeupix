...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('clientes.create')); ?>" class="btn btn-outline-primary">
                <i class="bi bi-person-plus me-2"></i> Novo Cliente
            </a>
            <a href="<?php echo e(route('dividas.create')); ?>" class="btn btn-success">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" style="color: #198754;">R$ <?php echo e(number_format($totalDividasPendentes, 2, ',', '.')); ?></h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 text-danger"><?php echo e($totalDividasVencidas); ?></h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" style="color: #0d6efd;"><?php echo e($totalClientes); ?></h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" style="color: #20c997;"><?php echo e($dividas->total()); ?></h3>
    ...
    <div class="row g-4">
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group btn-group-sm">
                            <a href="<?php echo e(route('dashboard', ['filtro' => 'todos'])); ?>"
                               class="btn btn-sm <?php echo e($filtro === 'todos' ? 'btn-dark' : 'btn-outline-dark'); ?>">Todos</a>
                            <a href="<?php echo e(route('dashboard', ['filtro' => 'pendente'])); ?>"
                               class="btn btn-sm <?php echo e($filtro === 'pendente' ? 'btn-dark' : 'btn-outline-dark'); ?>">Pendentes</a>
                            <a href="<?php echo e(route('dashboard', ['filtro' => 'vencido'])); ?>"
                               class="btn btn-sm <?php echo e($filtro === 'vencido' ? 'btn-dark' : 'btn-outline-dark'); ?>">Vencidas</a>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-modern mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $dividas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divida): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(route('clientes.show', $divida->cliente)); ?>" class="text-decoration-none fw-semibold" style="color: #198754;">
                                                    <?php echo e($divida->cliente->nome); ?>

                                                </a>
                                            </td>
                                            <td class="text-muted"><?php echo e(Str::limit($divida->descricao, 30)); ?></td>
                                            <td class="fw-bold" style="color: #198754;">R$ <?php echo e(number_format($divida->valor, 2, ',', '.')); ?></td>
                                            <td>
                                                <?php switch($divida->status):
                                                    case ('pendente'): ?>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('dividas.show', $divida)); ?>" class="btn btn-action btn-outline-primary" title="Ver">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
        ...
        <div class="col-lg-4">
            <div class="card chart-card mb-4">
                ...
                <div class="card-body p-0">
                    <?php if(isset($dividasPorCliente) && $dividasPorCliente->count() > 0): ?>
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = $dividasPorCliente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('clientes.show', $item->cliente_id)); ?>"
                                   class="list-group-item list-group-item-action d-flex justify-content-between align-items-center py-3">
                                    <div>
                                        <p class="mb-1 fw-semibold"><?php echo e($item->cliente->nome ?? 'Cliente'); ?></p>
                                        <small class="text-muted"><?php echo e($item->total); ?> dívida(s)</small>
                                    </div>
            ...
            <div class="card chart-card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom">
                        ...
                        <span class="fw-bold" style="color: #198754;"><?php echo e($dividas->where('status', 'pendente')->count()); ?></span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom">
                        <span class="text-muted">Dívidas Pagas:</span>
                        <span class="fw-bold text-success"><?php echo e($dividas->where('status', 'pago')->count()); ?></span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="text-muted">Dívidas Vencidas:</span>
                        <span class="fw-bold text-danger"><?php echo e($dividas->where('status', 'vencido')->count()); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    const evolucaoChart = new Chart(evolucaoCtx, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($evolucaoMensal->pluck('mes')); ?>,
            datasets: [{
                label: 'Valor das Dívidas (R$)',
                data: <?php echo json_encode($evolucaoMensal->pluck('total')); ?>,
                borderColor: '#198754',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wesley/cadeMeuPix/resources/views/dashboard/index.blade.php ENDPATH**/ ?>