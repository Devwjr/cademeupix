...
<div class="container">
    ...
    <div class="cta-section text-center mt-5">
        ...
        <a href="{{ route('register') }}" class="btn btn-light btn-lg px-5 py-3 fw-bold" style="color: #198754;">
        ...
        <div class="col-md-4">
            <div class="card pricing-card shadow-sm h-100">
                ...
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('register') }}" class="btn btn-outline-success w-100">Começar</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card pricing-card featured shadow-sm h-100">
                ...
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('register') }}" class="btn btn-success w-100">Assinar Agora</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card pricing-card shadow-sm h-100">
                ...
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('register') }}" class="btn btn-outline-success w-100">Falar com Vendas</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="{{ route('pricing') }}" class="text-muted small text-decoration-none">Planos</a></li>
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('support') }}" class="text-muted small text-decoration-none">Central de Ajuda</a></li>
